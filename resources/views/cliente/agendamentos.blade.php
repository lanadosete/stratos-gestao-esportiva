                        ...
                        <div class="list-group-item p-4 border-bottom border-light">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2 text-center border-end border-light mb-3 mb-md-0">
                                    ...
                                    <span class="text-muted text-uppercase small fw-bold d-block mb-2">
                                    ...
                                    @switch($statusCalc)
                                        ...
                                        @case('finalizado')
                                            ...
                                            @break
                                        @default
                                            <span class="badge bg-amber-soft text-amber px-3 py-2 rounded-pill fw-semibold">
                                ...
                                <div class="col-md-7 ps-md-4 mb-3 mb-md-0">
                                    <h5 class="fw-bold mb-1 text-dark">{{ $reserva->quadra->nome ?? 'Quadra Removida' }}</h5>
                                    <p class="text-muted mb-3 small">
                                        <i class="bi bi-geo-alt-fill text-success opacity-75 me-1"></i> {{ $reserva->quadra->arena->nome ?? 'Arena Stratos' }}
                                        <span class="mx-2 text-light-subtle">|</span>
                                        <i class="bi bi-trophy text-warning opacity-75 me-1"></i> {{ $reserva->esporte ?? 'Esporte' }}
                                    </p>
                                ...
                                <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow-lg rounded-4 text-center p-3">
                                                    ...
                                                    <div class="modal-body pb-4">
                                                        ...
                                                        <p class="text-muted mb-1">Tem certeza que deseja cancelar o jogo na <strong>{{ $reserva->quadra->nome ?? 'Quadra' }}</strong>?</p>
                                    ...
                                    @if($reserva->arena_whatsapp_link)
                                        <a href="{{ $reserva->arena_whatsapp_link }}" target="_blank" rel="noopener" class="btn btn-sm btn-outline-success w-100 py-2 fw-bold rounded-pill mt-2">
                ...
                <div class="list-group list-group-flush">
                    @forelse($historico as $reserva)
                        <div class="list-group-item p-4">
                            <div class="row align-items-center">
                                <div class="col-md-2 text-center border-end border-light mb-3 mb-md-0">
                                    <h4 class="fw-bold text-black mb-0">{{ \Carbon\Carbon::parse($reserva->data_reserva)->format('d') }}</h4>
                                    <span class="text-muted text-uppercase small">{{ \Carbon\Carbon::parse($reserva->data_reserva)->translatedFormat('M Y') }}</span>
                                </div>
                                <div class="col-md-7 ps-md-4 mb-3 mb-md-0">
                                    <h6 class="fw-bold text-secondary mb-1">{{ $reserva->quadra->nome ?? 'Quadra Removida' }}</h6>
                                    <p class="text-muted mb-2 small"><i class="bi bi-circle-fill text-secondary opacity-50 me-1" style="font-size: 0.5rem;"></i> {{ $reserva->esporte ?? 'Esporte' }}</p>
                                ...
                                <div class="col-md-3 text-md-end">
                                    ...
                                    @if($reserva->arena_whatsapp_link)
                                        <a href="{{ $reserva->arena_whatsapp_link }}" target="_blank" rel="noopener" class="btn btn-sm btn-outline-success w-100 py-2 fw-bold rounded-pill">
                                            <i class="bi bi-whatsapp me-1"></i> Entrar em contato
                                        </a>
                                    @endif
                                </div>
