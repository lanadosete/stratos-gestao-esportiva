...
<div class="d-flex flex-wrap gap-3 justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-0">Minhas Quadras</h3>
        <p class="text-muted mb-0">Gerencie as quadras da sua arena.</p>
    </div>
    <a href="/admin/quadras/nova" class="btn btn-verde fw-bold rounded-pill px-4 shadow-sm text-nowrap flex-shrink-0">
        <i class="bi bi-plus-lg me-1"></i> Nova Quadra
    </a>
</div>
...
<div class="d-flex flex-wrap gap-4">
            ...
            <div class="card card-stratos border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="/admin/quadras/{{ $quadra->id }}/editar" class="btn btn-outline-dark fw-bold rounded-pill flex-fill text-nowrap">
                            <i class="bi bi-pencil-square me-1"></i> Editar
                        </a>

                        <form action="/admin/quadras/{{ $quadra->id }}/excluir" method="POST" class="flex-fill" onsubmit="return confirm('Tem certeza que deseja apagar esta quadra definitivamente?');">
                            @csrf
    ...
    @empty
        <div class="text-center py-5 text-muted w-100">
            ...
            <h5>Nenhuma quadra cadastrada</h5>
            <p>Clique no botão "Nova Quadra" acima para começar.</p>
        </div>
    @endforelse
</div>
@endsection
