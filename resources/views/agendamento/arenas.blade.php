    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="d-flex flex-wrap gap-2 mb-5 mt-3">
                <span class="badge bg-success px-4 py-2 rounded-pill fs-6 fw-normal shadow-sm">1. Arena</span>
            ...
            <div class="mb-4">
                <h3 class="fw-bold mb-1">Escolha uma Arena Esportiva</h3>
            ...
            <div class="row g-4 pb-5">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card card-stratos p-4 shadow-sm border-0 h-100 d-flex flex-column">
                            <div class="mb-4">
                                ...
                                <small class="text-muted d-block mb-1"><i class="bi bi-geo-alt-fill text-success me-1"></i> {{ $arena->endereco }}</small>
                                <small class="text-muted"><i class="bi bi-grid-3x3-gap-fill text-success me-1"></i> {{ $arena->quadras_count }} {{ $arena->quadras_count == 1 ? 'quadra' : 'quadras' }}</small>
                            </div>
                            <a href="/agendamento/quadras?arena_id={{ $arena->id }}" class="btn btn-verde w-100 py-2 fw-bold rounded-pill shadow-sm mt-auto">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        ...
                        <h4 class="fw-bold text-dark">Nenhuma arena encontrada</h4>
