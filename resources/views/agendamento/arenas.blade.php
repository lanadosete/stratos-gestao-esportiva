...
<div class="container-fluid p-0">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="mb-4">
                <h3 class="fw-bold mb-1">{{ $complexo->nome }}</h3>
                <p class="text-muted mb-0"><i class="bi bi-geo-alt-fill text-success me-1"></i> {{ $complexo->endereco }}</p>
            </div>

            <div class="row g-4 pb-5">
                @forelse($arenas as $arena)
                    @php
                        $esportesAtivos = $arena->esportes->where('ativo', true);
                        $menorPreco = $arena->precosTurno->min('valor_hora');
                    @endphp
                    <div class="col-md-6 col-lg-4">
                        <div class="card card-stratos p-4 shadow-sm border-0 h-100 d-flex flex-column">
                            <div class="mb-3">
                                <h5 class="fw-bold mb-2 text-dark">{{ $arena->nome }}</h5>
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center border-top pt-3">
                                ...
                                <a href="/agendamento/data?arena_id={{ $arena->id }}" class="btn btn-verde px-4 py-2 fw-bold rounded-pill shadow-sm {{ $esportesAtivos->isEmpty() || !$menorPreco ? 'disabled' : '' }}">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        ...
                        <h4 class="fw-bold text-dark">Nenhuma quadra cadastrada neste complexo</h4>
                        <p class="text-muted">Volte e escolha outro complexo, ou tente novamente mais tarde.</p>
                    </div>
                @endforelse
            </div>
